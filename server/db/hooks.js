...
//a hook for users to create an order after the user is created so there is always an empty order in the database to be used by the cart on the client side
